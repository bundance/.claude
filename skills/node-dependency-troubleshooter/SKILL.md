---
name: node-dependency-troubleshooter
# prettier-ignore
description: Comprehensive Node.js dependency troubleshooting for npm, yarn, pnpm, and related tooling. Use when encountering (1) Package installation failures or dependency conflicts, (2) Module resolution errors or missing dependencies, (3) TypeScript configuration issues (tsconfig.json), (4) ESLint, Prettier, or other build tool configuration problems, (5) Version mismatch errors between Node.js and packages, (6) Lock file conflicts or corruption, (7) Peer dependency warnings or errors, (8) Expo SDK dependency issues. Triggered by error messages or phrases like "dependency error", "npm install failing", "yarn/pnpm error", "module not found", "TypeScript config issue", "eslint not working", "cannot find module", "peer dependency", "ERESOLVE", or any package manager or build tool errors.
---
...
# DEPENDENCY ANALYSIS
# Analyze lock file for duplicatesrm 
